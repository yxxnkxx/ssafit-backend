...
<div class="d-flex flex-row-reverse" id="head-container">
  ...
  <c:if test="${!empty loginUser }">
    ...
    <div class="p-2"><a href="${pageContext.request.contextPath}/user?action=logout">로그아웃</a></div>
    <div class="p-2"><a href="${pageContext.request.contextPath}/user?action=likeList">찜 리스트</a></div>
   </c:if>
